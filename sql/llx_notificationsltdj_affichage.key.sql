...
--ALTER TABLE llx_notificationsltdj_affichage ADD UNIQUE INDEX uk_notificationsltdj_affichage_fieldxy(fieldx, fieldy);

--ALTER TABLE llx_notificationsltdj_affichage ADD CONSTRAINT llx_notificationsltdj_affichage_fk_field FOREIGN KEY (fk_field) REFERENCES llx_notificationsltdj_myotherobject(rowid);
