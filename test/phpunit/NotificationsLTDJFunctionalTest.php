...
/**
 * \file    test/phpunit/NotificationsLTDJFunctionalTest.php
...
/**
 * Class NotificationsLTDJFunctionalTest
 *
 ...
 *
 * @package Testnotificationsltdj
 */
class NotificationsLTDJFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modNotificationsLTDJ')->click();
		} else {
			// Disable the module
			$this->byHref('modNotificationsLTDJ')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/notificationsltdj/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('notificationsltdj/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/notificationsltdj/admin/about.php');
		$this->authenticate();
		return $this->assertContains('notificationsltdj/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('notificationsltdjwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modNotificationsLTDJ_NotificationsLTDJTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modNotificationsLTDJ_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
